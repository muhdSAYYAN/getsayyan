    ...
    <div className="relative min-h-screen flex flex-col justify-between overflow-x-hidden text-white pt-32 bg-transparent">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 flex-grow w-full">
        <div className="flex items-center gap-2 text-xs tracking-widest text-white/40 uppercase mb-8">
          ...
          <span>/</span>
          <span className="text-white/80">Velota</span>
        </div>

        <h1 className="text-4xl md:text-6xl font-black tracking-tighter mb-4 leading-tight">
          VELOTA | ANALYTICAL DASHBOARD
        </h1>

        <p className="text-xl text-neutral-300 leading-relaxed mb-8">
          A high-speed analytical portal and custom dashboard engineered for real-time data visualization and operational tracking.
        </p>

        <div className="flex flex-wrap gap-3 mb-12">
          {["Next.js", "TypeScript", "GSAP", "Prisma", "Tailwind CSS"].map((tool) => (
        ...
        <div className="relative aspect-[16/9] w-full overflow-hidden rounded-3xl border border-white/10 mb-16">
          <Image
            src="/images/velota-dashboard-nextjs-typescript.jpeg"
        ...
        <div className="space-y-12 text-neutral-300 text-lg leading-relaxed">
          <div>
            ...
            <p>
              Velota required a lightweight, lightning-fast web platform paired with internal metrics dashboards to track key performance indicators.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-4">
                ...
                <span>Next.js App Router architecture paired with TypeScript for compile-time type safety.</span>
              </li>
              <li className="flex items-start gap-4">
                <CheckCircle2 className="w-6 h-6 text-slate-300 shrink-0 mt-1" />
                <span>GSAP animation integration delivering fluid micro-interactions and scroll-driven reveals.</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-white/10 text-center">
          ...
          >
            → Build a Custom Dashboard <ArrowRight className="w-4 h-4" />
          </Link>
        </div>
      </main>
