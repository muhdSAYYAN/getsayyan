  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 w-full flex-grow flex flex-col items-center">
        {/* Existing Contact Component wrapped in Suspense for searchParams */}
        <div className="w-full">
          <Suspense fallback={<div className="h-[600px] flex items-center justify-center text-white/20">Loading form...</div>}>
            <ContactSection />
          </Suspense>
        </div>
          ...
          <GsapFade direction="up" delay={0.1}>
            <div className="text-center mb-16">
              ...
              <p className="text-neutral-400 max-w-2xl mx-auto">
                A simple and transparent process to turn your ideas into digital reality.
              </p>
            </div>
          </GsapFade>
